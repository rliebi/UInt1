...
public class BookPanel extends AbstractPanel {
	...
	private java.util.List<RowFilter<Object, Object>> filters = new ArrayList<RowFilter<Object, Object>>(
			3);
	...
	private void initialize() {
		...
		panelInventoryStatistik.setBorder(new TitledBorder(null, Messages
				.getString("BookPanel.InventoryStatistics.Title"),
		...
		JLabel lblNumberOfTitles = new JLabel(
				Messages.getString("BookPanel.InventoryStatistics.Count"));
		...
		JLabel lblNumberOfBooks_1 = new JLabel(
				Messages.getString("BookPanel.InventoryStatistics.CopyCount"));
		...
		gbl_panelBookInventory.columnWeights = new double[] { 0.0, 1.0, 0.0,
...
//		});
		...
		btnDisplayBook = new JButton(
				Messages.getString("BooksPanel.DetailButton.title"));
		...
		JButton btnAddNewBook = new JButton(
				Messages.getString("BooksPanel.AddButton.title"));
	...
	private void setModel(BookTableModel model) {
		...
		book_table.getColumnModel().getColumn(0)
	...
	private final class BookInfoAction extends AbstractAction {
		/**
		 * 
		 */
