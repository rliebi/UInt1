...
public class EditBook extends Observable implements Observer {
	...
	private void initialize() {
		...
		panel.setBorder(new TitledBorder(null, bookInformationLabelText,
	...
	private void saveBook() {
		theBook.setName(txtFieldBookTitle.getText());
		theBook.setAuthor(txtFieldBookAuthor.getText());
		theBook.setPublisher(txtFieldBookPublisher.getText());
		theBook.setShelf((Shelf) cmbFieldShelfNumber.getSelectedItem());
	}
